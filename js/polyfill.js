	    ...
	    */
	    ...
	    jQuery.fn.wordBreakKeepAll = function (option) {
	        var _ua = navigator.userAgent,
	            is_there_end_angle_bracket,
	            is_there_start_angle_bracket,
	            is_there_no_angle_bracket,
	            defaultOption,
	            opt;
	
	        is_there_end_angle_bracket = function is_there_end_angle_bracket(str) {
	            return str.lastIndexOf('<') < str.lastIndexOf('>');
	        };
	        is_there_start_angle_bracket = function is_there_start_angle_bracket(str) {
	            return str.lastIndexOf('>') < str.lastIndexOf('<');
	        };
	        is_there_no_angle_bracket = function is_there_no_angle_bracket(str) {
	            return str.lastIndexOf('>') == str.lastIndexOf('<');
	        };
	        defaultOption = {
	            OffForIE: false,
	        ...
	        if (/MSIE/.test(_ua) && opt.OffForIE == false && opt.useCSSonIE == true) {
	            var addWordBreakKeepAll = function addWordBreakKeepAll(obj) {
	                $(obj).css({
	                    'word-break': 'keep-all',
	        ...
	        } else if (!/MSIE/.test(_ua) || /MSIE/.test(_ua) && opt.OffForIE == false && opt.useCSSonIE == false) {
	            var addWordBreakKeepAll = function addWordBreakKeepAll(obj) {
	                var html = $(obj).html();
	                html = html.replace(/(\r\n|\n|\r)/gm, ' ＃＆＊＠§ ');
